...
export const AddCourse = () => {
    ...
    const addCourse = async () => {
        ...
        let response = await actions.fetchPromise("/api/Course", "POST", obj);
        if (response.ok) {
                ...
                <form className="addCourse_form my-5" id="addCourse_form">
                    ...
                    <div>
                        <div className="d-flex justify-content-between align-items-center pb-4">
                            ...
                            <input type="text" className="addCourse_input" onChange={(e) => {
                        ...
                        <div className="d-flex justify-content-between align-items-center pb-4">
                            ...
                            <select placeholder="Eliga una categoria" className="picker addCourse_input">
                        ...
                        <div className="d-flex justify-content-between align-items-center pb-4">
                            ...
                            <input type="number" min="0" className="addCourse_input" onChange={(e) => {
                                setCost(e.target.value);
                            }} />
                        </div>
                        <div className="d-flex justify-content-between align-items-center pb-4">
                            <label className="me-3">Descripción</label>
                            <textarea rows={6} form="addCourse_form" className="addCourse_textarea" onChange={(e) => {
                    ...
                    <input type="button" value="Agregar" className="addCourse_button my-4" onClick={addCourse} />
                </form>
            </div>
        </>
    );
